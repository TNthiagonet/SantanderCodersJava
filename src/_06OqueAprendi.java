public class _06OqueAprendi {
    public static void main(String[] args) {
        ...
        System.out.println(" Aluno: Thiago Bruno Menezes da Costa");
        ...
        System.out.println("4- Aprendi como criar variáveis para armazenar textos (String), números inteiros (int) e números decimais (float).");
        System.out.println("5- Aprendi como usar os operadores aritméticos: Soma (+), Subtração (-), Multiplicação (*) e Divisão (/).");
        System.out.println("6- Aprendi até aqui.");
    }
}
